...
/**
 * Automated UI test for user functions in admin profile page
 * @author herje
 * @version 1
 */
...
class UserFragmentTest {
    ...
    private fun init() {
        ...
        onView(withId(R.id.usersBtn)).perform(ViewActions.click())
     ...
     */
    @Test
    fun test_navigation_login_admin_users_list(){

        init()
        onView(withId(R.id.userListFragment)).check(matches(isDisplayed()))
    }
}