...
/**
 * Automated UI test for admin profile page
 * @author herje
 * @version 1
 */
@RunWith(AndroidJUnit4ClassRunner::class)
class AdminProfileFragmentTest {
    ...
    */
    ...
    /**
     * Test if the fragment shown is the admin page
     */
    @Test
    fun test_navigation_login_admin(){

        init()
        onView(withId(R.id.adminProfileFragment)).check(matches(isDisplayed()))
    }
}